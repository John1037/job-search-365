...
export const DEFAULT_SORT = { field: 'date_logged', direction: 'desc' };
...
// applied in order as tie-breakers. Falls back to DEFAULT_SORT when empty.
export function sortJobs(jobs, sortLevels) {
  const levels = sortLevels.length > 0 ? sortLevels : [DEFAULT_SORT];
