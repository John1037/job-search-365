// name, ISO 3166-1 alpha-2 code, international calling code
const countries = [
...
// Regional-indicator trick: each letter A-Z maps to a Unicode flag-letter
// symbol; two of them together render as the country's flag emoji.
...
const PRIORITY_CODES = ['GB', 'US'];

export const sortedCountries = [
  ...PRIORITY_CODES.map((code) => countries.find((c) => c.code === code)),
  ...countries
